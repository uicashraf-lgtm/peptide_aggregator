...
.pa-shell .pa-detail-vendor-list{display:flex!important;flex-direction:column!important;padding:0 10px 6px!important}
.pa-shell .pa-detail-vrow{display:grid!important;grid-template-columns:40px 1fr auto!important;gap:12px!important;align-items:center!important;padding:12px 10px!important;border-radius:0!important;border-bottom:1px solid var(--line)!important}
...
';
    ...
    public function register_assets() {
        ...
        wp_register_style('pa-dashboard-css',   plugin_dir_url(__FILE__) . '../assets/css/dashboard.css', $css_deps, '0.9.33');
