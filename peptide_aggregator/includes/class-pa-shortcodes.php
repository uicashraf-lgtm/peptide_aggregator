...
';
    ...
    public function register_assets() {
        ...
        wp_register_script('pa-dashboard-js',   plugin_dir_url(__FILE__) . '../assets/js/dashboard.js',   array(), PA_PLUGIN_VERSION, false);
        wp_register_script('pa-suppliers-js',   plugin_dir_url(__FILE__) . '../assets/js/suppliers.js',   array(), PA_PLUGIN_VERSION, false);
        ...
        if (!is_admin()) {
            ...
            wp_add_inline_script('pa-dashboard-js',
                'window.PA_UI = {' .
                    ...
                    'price_tiers:'   . json_encode( (object) get_option('pa_price_tiers', array()) ) .
                '};',
                'before'
            );
    ...
    public function render_dashboard_shortcode() {
        ...
        window.PA_UI.price_tiers  = <?php echo json_encode( (object) get_option('pa_price_tiers', array()) ); ?>;
        </script>
        <div class="pa-shell">
