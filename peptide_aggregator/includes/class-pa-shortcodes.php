...
.pa-shell .pa-detail-vrow-right{display:flex!important;flex-direction:column!important;align-items:flex-end!important;gap:3px!important;flex-shrink:0!important}.pa-shell .pa-detail-price-row{display:flex!important;flex-direction:row!important;align-items:center!important;gap:6px!important}
...
.pa-sort-item{display:flex!important;align-items:center!important;justify-content:space-between!important;gap:10px!important;padding:10px 12px!important;cursor:pointer!important;background:#ffffff!important;border:none!important;width:100%!important;border-radius:6px!important;text-align:left!important}
.pa-sort-item:hover{background:#f0f5ff!important}
.pa-sort-item span{color:#1a2332!important;font-size:13px!important;font-weight:500!important}
.pa-sort-item:hover span{color:#1a2332!important}
.pa-sort-item.is-selected span,.pa-sort-item.is-active span{color:#2563eb!important;font-weight:600!important}
...
.pa-shell .pa-detail-vrow{grid-template-columns:40px minmax(0,1fr) auto!important;gap:8px!important;padding:10px 8px!important}.pa-shell .pa-detail-link-icon{width:20px!important;height:20px!important}.pa-shell .pa-detail-link-icon svg{width:12px!important;height:12px!important}
...
';
    ...
    private function enqueue_dashboard_assets() {
        ...
        $initial_slug = (string) get_query_var('pa_product_slug', '');
        wp_add_inline_script('pa-dashboard-js',
            'window.PA_UI = {' .
                ...
                'prices_base_url:' . json_encode(home_url('/prices')) . ',' .
                'initial_product_slug:' . json_encode($initial_slug) . ',' .
    ...
    public function render_dashboard_shortcode() {
        ...
        window.PA_UI.prices_base_url = <?php echo json_encode(home_url('/prices')); ?>;
        window.PA_UI.initial_product_slug = <?php echo json_encode((string) get_query_var('pa_product_slug', '')); ?>;
